...
- **app** - Demo App
- **lib** - Library
- **engine** - Event Binding Engine
- **parser** - Event Binding Parser
- **loader** - HTML Loader
- **plugin** - Plugin used to modify the webpack configuration
- **internal** - General changes to the internal package
- **transformers** - Changes related to the TS transformers
